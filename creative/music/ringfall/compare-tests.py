...
files={
'Night Watch':r'C:\Users\jazzs\Downloads\Lunar_Observatory_Night_Watch_2026-09-25T222715.mp3',
'Dusk':r'C:\Users\jazzs\Downloads\Lunar_Observatory_Dusk_2026-09-25T222715.mp3',
'Reference':r'C:\Users\jazzs\Downloads\YTDown.com_YouTube_Media_KO0k7at4qCs_DEAD-WATER-Deep-Ambient-Music-Underground-Waterfall-Ambience_009_128k.mp3'}
result={}
for name,path in files.items():
    args=[FF,'-v','error']
    if name=='Reference':args+=['-ss','60']
    args+=['-i',path,'-t','120','-ar','22050','-ac','2','-f','f32le','pipe:1']
    ...
    q=subprocess.run([FF,'-hide_banner','-i',path,'-t','120','-af','ebur128=peak=true','-f','null','-'],capture_output=True)
