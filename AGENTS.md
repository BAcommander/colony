...
Current scene (2026-09-25): Glacier Sanctuary v8b water reconstruction pending user review. User explicitly requested foreground snow removed and rejected repeated barely changing water tweaks. Foreground snow now absent. scripts/water_surface.py reconstructs a continuous reflection surface using24 crossing perspective wave components, source-texture reconstruction with ice/shore excluded, and slope-driven reflectance. This replaces sparse glints, not another opacity adjustment. V8 internal broad-wave test was too blurred; v8b refined it before delivery. Review creative/glacier-sanctuary/animation/review-v8b/combined.mp4 and water.mp4. Config scene-plan-v8b.json; brief production-prompt-v8b.md; water-method-status.json records rejected methods. All other effects match v7 at sampled times. Not seamless/final; user judgment pending. Do not revive rejected glint/band methods by simply adjusting amplitude.
