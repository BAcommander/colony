...
Current scene (2026-09-25): Basalt Transmission. User called v1b a good start but requested more background life: wind across the plains, sky and haze movement. Current revision v2 adds nine low dust sheets with forward transport and rock occlusion, broader/faster haze material, and evolving detail within existing cloud bands. Retains habitat/exhaust/window behavior. Configuration: creative/basalt-transmission/animation/scene-plan-v2.json; brief: production-prompt-v2.md beside it. Render with scripts/render_basalt.py --version v2; assemble with scripts/assemble_basalt.py --version v2. Versioned v1b remains untouched. Review exports are baseline-v2-preview.mp4 and baseline-v2-20min-4k.mp4; see reports for completed verification. User artistic approval remains pending; Ringfall is still the approved quality reference. Long videos stay local because they exceed ordinary GitHub file limits.
