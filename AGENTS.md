...
Current scene (2026-09-25): Glacier Sanctuary v6 pending review. User requested heavier snow, more exterior flicker and better efficiency; water v5 rejected. V6 increases snow210 to326, preserves original water geometry with sparse moving glints instead of distortion, and adds staggered short lamp dips coupled to halos/snow pools. Fog, roof exhaust, dome lantern and annex event match v5. Preview creative/glacier-sanctuary/animation/review-v6/combined.mp4; water-v5-v6-comparison/water.mp4 is full-size stacked v5 top/v6 bottom. Brief production-prompt-v6.md. Reusable presets now in creative/effect-presets.json via scripts/apply_scene_presets.py; render_glacier.py supports --layers and --compare-config. Do not equate documenting lessons with implementing reusable controls. Masks remain scene-specific; no one-shot guarantee. Not seamless/final. Basalt/Ringfall accepted media stay unchanged.
