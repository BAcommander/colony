...
Current scene (2026-09-25): Glacier Sanctuary concept 02 is now in development. First eight-second motion study: creative/glacier-sanctuary/animation/review-v1/combined.mp4, with isolated atmosphere and water clips. Source: creative/concepts/02-glacier-sanctuary.png. Renderer scripts/render_glacier.py; source-space parameters and masks in scene-plan-v1.json; detailed brief in production-prompt-v1.md in the scene animation folder. Main effects: sheltered-opening snowfall, coherent mountain mist, small open-water ripples excluding ice/shore, supporting annex-vent exhaust. Lighting stays steady. This is NOT a seamless loop or an accepted final; visual review pending. Preserve Basalt v6 and Ringfall v9b as accepted references. Basalt master is backed up with Git LFS; verified restore record remote-backup-v6.json.
