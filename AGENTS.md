...
Current scene (2026-09-25): Glacier Sanctuary v5 motion study pending review. User requested more realistic water and obvious pulsing upper-dome light. V5 removes added water brightness bands, uses five directional wave slopes to distort original reflections with distance scaling, and adds a warm upper-lantern lit/dim/return event. This is a masked2D approximation, not a physical fluid simulation. Research/source and parameters: creative/glacier-sanctuary/animation/production-prompt-v5.md and scene-plan-v5.json. Preview review-v5/combined.mp4 with water and dome_light isolates. Fog, snow, smoke, path lights and annex event preserved against v4 at sampled times. Not a seamless final. Basalt v6/Ringfall v9b remain accepted finals.
