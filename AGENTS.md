...
Current scene (2026-09-25): Basalt v4 was rejected for insufficiently visible right-side smoke and no readable rear-ground motion. V3 was too smoky in the middle-right while the far/top remained static. Neither is approved. Stop amplitude-only revisions and long exports. Read creative/pipeline-audit-2026-09-25/AUDIT.md. New scripts/motion_review.py generates separate full-frame 720p sky/far-haze/near-wind/combined excerpts and provenance; final rendering and long assembly require a matching accepted visual-review record. Record actual user feedback, never self-award acceptance. Ringfall v9b remains the accepted aesthetic reference, not proof that its small localized effects solve broad landscape motion.
