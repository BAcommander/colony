...
Current scene (2026-09-25): Glacier Sanctuary v2 is an eight-second motion study, pending review. User approved v1 snow but could not see mist/water clearly, wanted stronger roof plume and light activity. Preserve snow exactly. V2 adds defined moving mountain mist banks, stronger masked water ripples with broken moving highlights, larger roof exhaust and a slow dim/return event in the annex right window bay. Dome and primary lighting stay steady. Preview creative/glacier-sanctuary/animation/review-v2/combined.mp4; isolated mist, water and roof_lights clips alongside. Brief production-prompt-v2.md and scene-plan-v2.json in the scene folder; renderer scripts/render_glacier.py. Review water for stripe-like artifacts and mist for excess fog. Not seamless or final; no long/4K export yet. Basalt v6 and Ringfall v9b remain accepted references.
