...
Current scene (2026-09-25): Basalt v6 is a twenty-second 720p loop test, pending visual review. User liked v5 cloud visibility but found it fast and missed plains smoke. V6 halves cloud-copy travel to 4.5 source px/s, uses locally staggered overlapping cloud lifetimes, restores visible near-plains wind with centered trajectories, and makes far sheets periodic. Brief: creative/basalt-transmission/animation/production-prompt-v6.md. Preview: review-v6/combined.mp4 in that directory. Inspect local cloud blending for softness/ghosting in playback; numerical seam checks are not visual acceptance. No long/4K export yet. Ringfall v9b remains approved. V5 remains a non-looping historical prototype; v3/v4 rejected. Preserve originals and actual user verdicts.
